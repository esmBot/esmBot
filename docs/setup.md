...
=== "Ubuntu"
    ...
    ```sh
    sudo apt-get install git curl build-essential cmake ninja-build ffmpeg sqlite3 ttf-mscorefonts-installer liblqr-1-0-dev libvips-dev libzxing-dev
    ```
...
=== "Fedora/RHEL"
    ...
    ```sh
    sudo dnf install git curl cmake ninja-build ffmpeg sqlite gcc-c++ liblqr-1-devel vips-devel cabextract zxing-cpp-devel
    ```
...
=== "Alpine"
    ...
    ```sh
    sudo apk add git curl msttcorefonts-installer python3 sqlite alpine-sdk cmake ninja ffmpeg vips-dev zxing-cpp-dev
    ```
...
=== "Arch/Manjaro"
    ...
    ```sh
    sudo pacman -S git curl cmake ninja ffmpeg npm liblqr libvips sqlite zxing-cpp
    ```
