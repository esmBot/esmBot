...
=== "Alpine"
    ...
    ```sh
    sudo apk add git curl msttcorefonts-installer python3 sqlite alpine-sdk cmake ffmpeg vips-dev zxing-cpp-dev
    ```
...
=== "Arch/Manjaro"
    ...
    ```sh
    sudo pacman -S git curl cmake ffmpeg npm liblqr libvips sqlite zxing-cpp
    ```
